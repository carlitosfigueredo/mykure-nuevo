...
router.get('/', async(req, res, next) => {
    try {
        ...
        const eventosSecundarios = await db.query('SELECT * FROM eventoSecundario LIMIT 5');
        ...
        res.render('index', { ganancias: ganancias[0], pulseras: pulseras[0], personasRegistradas: personasRegistradas[0], eventos, cuentaGrupos: cuentaGrupos[0], cuentaParticipantes: cuentaParticipantes[0], eventosSecundarios });
    } catch (err) {
        console.log(err);
